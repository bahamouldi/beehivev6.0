"""
BeeWAF Mega Rules Database — Part 8
=====================================
...
API_ENDPOINT_DEEP = [
    ...
    r"(?i)/api/v\d+/(?:internal|private|admin|test|staging|dev)\b",
    r"(?i)/api/v\d+/(?:secrets|credentials|passwords|apikeys|keys)\b",
    r"(?i)/api/v\d+/(?:backup|restore|database|dump|migrate|seed)\b",
    r"(?i)/api/v\d+/query\b",
