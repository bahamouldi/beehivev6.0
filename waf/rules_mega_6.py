...
API_ABUSE = [
    # --- REST API abuse ---
    r"(?i)/api/v\d+/(?:admin|internal|debug|test|staging|dev|management|config|secrets|credentials|passwords|keys|acls|migrations|backups|deployments|builds|pipelines|vulnerabilities|scans|seed|dump|eval|shell|backdoor|phpinfo|console)\b",
